        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <div className="mx-auto w-full max-w-md">
                ...
                <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-md p-4">
                  <div className="flex">
                    ...
                    <div className="ml-3 text-sm text-yellow-700">
                      You’re logged in as a recruiter ({user?.email}). Logout to continue as a job seeker.
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="remember-me" className="ml-2 text-medium">
                      Remember me
                    </label>
                  </div>
                  <Link
              ...
              <div className="text-medium mt-6 text-center space-y-2">
                <p>
                  Don't have an account?{' '} 
                  <Link to="/user/signup" className="text-blue-600 hover:underline font-medium hover:text-underline">
                    Sign up here
                  </Link>
                </p>
                <p>
                  Are you a recruiter? {' '}
                  <Link to="/recruiter/login" className="text-blue-600 hover:underline font-medium text-primary">
                    Recruiter Login
                  </Link>
                </p>
              </div>
