...
const RecruiterSignup = () => {
  ...
  useEffect(() => {
    if (isAuthenticated()) {
      ...
      // If user is authenticated but not a recruiter, let them stay on this page
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h2 className="text-3xl font-bold bg-gradient-to-r from-teal-700 to-teal-800 bg-clip-text text-transparent">Create Recruiter Account</h2>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>You're currently logged in as a job seeker ({user?.email}). To create a recruiter account, you need to logout first.</p>
                  </div>
                  <div className="mt-4">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-teal-700 to-teal-800 hover:from-teal-800 hover:to-teal-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
